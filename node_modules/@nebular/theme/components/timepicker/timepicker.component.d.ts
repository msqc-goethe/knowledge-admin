...
export declare class NbTimePickerComponent<D> implements OnChanges, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NbTimePickerComponent<any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NbTimePickerComponent<any>, "nb-timepicker", ["nbTimepicker"], { "showFooter": "showFooter"; "timeFormat": "timeFormat"; "twelveHoursFormat": "twelveHoursFormat"; "withSeconds": "withSeconds"; "singleColumn": "singleColumn"; "step": "step"; "date": "date"; "hoursText": "hoursText"; "minutesText": "minutesText"; "secondsText": "secondsText"; "ampmText": "ampmText"; "applyButtonText": "applyButtonText"; "currentTimeButtonText": "currentTimeButtonText"; }, { "onSelectTime": "onSelectTime"; }, never, never>;
}
export {};
