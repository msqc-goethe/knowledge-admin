...
export declare class NbAutocompleteDirective<T> implements OnDestroy, AfterViewInit, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NbAutocompleteDirective<any>, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NbAutocompleteDirective<any>, "input[nbAutocomplete]", never, { "overlayOffset": "overlayOffset"; "scrollStrategy": "scrollStrategy"; "autocomplete": "nbAutocomplete"; "focusInputOnValueChange": "focusInputOnValueChange"; "customOverlayHost": "customOverlayHost"; }, {}, never>;
}
