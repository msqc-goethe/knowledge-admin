...
export declare class NbRevealCardComponent {
    ...
    toggle(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NbRevealCardComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NbRevealCardComponent, "nb-reveal-card", never, { "revealed": "revealed"; "showToggleButton": "showToggleButton"; }, {}, never, ["nb-card-front", "nb-card-back"]>;
}
