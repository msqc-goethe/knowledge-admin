...
export declare class NbCalendarRangeYearCellComponent<D> extends NbBaseCalendarRangeCell<D> implements NbCalendarCell<D, NbCalendarRange<D>> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NbCalendarRangeYearCellComponent<any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NbCalendarRangeYearCellComponent<any>, "nb-calendar-range-year-cell", never, { "size": "size"; "date": "date"; "min": "min"; "max": "max"; "selectedValue": "selectedValue"; }, { "select": "select"; }, never, never>;
}
