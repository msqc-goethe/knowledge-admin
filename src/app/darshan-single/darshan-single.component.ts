...
@Component({
  selector: 'app-darshan-single',
  templateUrl: './darshan-single.component.html',
  styleUrls: ['./darshan-single.component.scss']
})
export class DarshanSingleComponent implements OnInit {
